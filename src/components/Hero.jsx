...
const Hero = () => {
  return (
    <div className="relative w-full h-screen">
      <div
        className={`${styles.paddingX} absolute flex flex-row gap-5 xs:mt-[5rem] sm:mt-[4.5rem] md:mt-[4rem] mt-[5rem]`}
      >
        ...
        <div>
          ...
          <p
            className={`${styles.heroSubText} mr-[4vw] mt-[2vh] text-white-100`}
          >
            Welcome, I'm a&nbsp;
